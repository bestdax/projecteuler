...
TEST(NUMBER, GET_DIGITS)
{
	...
	EXPECT_EQ(dax::get_digits(11123234), d);
}

TEST(NUMBER, GET_UNIQUE_DIGITS)
{
	std::vector<unsigned> d{0, 1, 2};
	EXPECT_EQ(dax::get_unique_digits(112200), d);
}

TEST(NUMBER, DIGITS_TO_NUMBER)
{
	std::vector<unsigned> d{1, 2, 3, 4, 5, 0};
	EXPECT_EQ(dax::digits_to_number(d), 123450);
}

TEST(NUMBER, HAS_ZERO)
{
	EXPECT_TRUE(dax::has_digit(112200, 0));
	EXPECT_FALSE(dax::has_digit(123456, 0));
}

TEST(NUMBER, HAS_SAME_DIGIT)
{
	EXPECT_TRUE(dax::has_same_digit(12345, 56789));
	EXPECT_FALSE(dax::has_same_digit(12345, 6789));
}
...
TEST(NUMBER, CANCEL_SAME_DIGIT)
{
	...
	EXPECT_EQ(dax::cancel_same_digit(12456, 2345), t);
}

TEST(NUMBER, HAS_EXACT_SAME_DIGITS)
{
	EXPECT_TRUE(dax::has_exact_same_digits(125874, 251748));
}

TEST(NUMBER, ROTATE)
{
	EXPECT_EQ(dax::rotate(2345), 5234);
	EXPECT_EQ(dax::rotate(5234), 4523);
	EXPECT_EQ(dax::rotate(4523), 3452);
	EXPECT_EQ(dax::rotate(3452), 2345);
}
...
{
	EXPECT_TRUE(dax::has_same_digit(11));
	EXPECT_FALSE(dax::has_same_digit(2345));
}

TEST(NUMBER, IS_N_PANDIGITAL)
{
	EXPECT_TRUE(dax::is_n_pandigital(1234));
	EXPECT_TRUE(dax::is_n_pandigital(23451));
	EXPECT_TRUE(dax::is_n_pandigital(987654321));
	EXPECT_TRUE(dax::is_n_pandigital(56813247));
	EXPECT_FALSE(dax::is_n_pandigital(2345));
	EXPECT_FALSE(dax::is_n_pandigital(1223));
	EXPECT_FALSE(dax::is_n_pandigital(34567));
	EXPECT_FALSE(dax::is_n_pandigital(654327));
}


TEST(NUMBER, IS_TRIANGLE_NUMBER)
{
	EXPECT_TRUE(dax::is_triangle_number(1));
	EXPECT_TRUE(dax::is_triangle_number(3));
	EXPECT_TRUE(dax::is_triangle_number(6));
	EXPECT_TRUE(dax::is_triangle_number(10));
	EXPECT_TRUE(dax::is_triangle_number(15));
	EXPECT_TRUE(dax::is_triangle_number(21));
	EXPECT_TRUE(dax::is_triangle_number(28));
	EXPECT_TRUE(dax::is_triangle_number(36));
	EXPECT_TRUE(dax::is_triangle_number(45));
	EXPECT_TRUE(dax::is_triangle_number(55));
	EXPECT_FALSE(dax::is_triangle_number(2));
	EXPECT_FALSE(dax::is_triangle_number(56));
}

TEST(NUMBER, IS_PENTAGONAL_NUMBER)
{
	EXPECT_TRUE(dax::is_pentagonal_number(1));
	EXPECT_TRUE(dax::is_pentagonal_number(5));
	EXPECT_TRUE(dax::is_pentagonal_number(12));
	EXPECT_TRUE(dax::is_pentagonal_number(22));
	EXPECT_TRUE(dax::is_pentagonal_number(35));
	EXPECT_TRUE(dax::is_pentagonal_number(51));
	EXPECT_TRUE(dax::is_pentagonal_number(70));
	EXPECT_TRUE(dax::is_pentagonal_number(92));
	EXPECT_TRUE(dax::is_pentagonal_number(117));
	EXPECT_TRUE(dax::is_pentagonal_number(145));
}

TEST(NUMBER, IS_HEXAGONAL_NUMBER)
{
	EXPECT_TRUE(dax::is_hexagonal_number(1));
	EXPECT_TRUE(dax::is_hexagonal_number(6));
	EXPECT_TRUE(dax::is_hexagonal_number(15));
	EXPECT_TRUE(dax::is_hexagonal_number(28));
	EXPECT_TRUE(dax::is_hexagonal_number(45));
}

TEST(NUMBER, FACTORIAL)
{
	EXPECT_EQ(dax::factorial(0), 1);
	EXPECT_EQ(dax::factorial(5), 120);
}

TEST(NUMBER, COMBINATION)
{
	EXPECT_EQ(dax::combination(5, 3), 10);
	EXPECT_EQ(dax::combination(23, 10), 1144066);
	EXPECT_EQ(dax::combination(23, 11), 1144066 * 13 / 11);
}

TEST(NUMBER, PERMUTATION)
{
	EXPECT_EQ(dax::permutation(5, 3), 60);
}
...
{
	EXPECT_TRUE(dax::is_heptagonal_number(1));
	EXPECT_TRUE(dax::is_heptagonal_number(7));
	EXPECT_TRUE(dax::is_heptagonal_number(18));
	EXPECT_TRUE(dax::is_heptagonal_number(34));
	EXPECT_TRUE(dax::is_heptagonal_number(55));
	EXPECT_TRUE(dax::is_heptagonal_number(81));
}

TEST(NUMBER, IS_OCTAGONAL)
{
	EXPECT_TRUE(dax::is_octagonal_number(1));
	EXPECT_TRUE(dax::is_octagonal_number(8));
	EXPECT_TRUE(dax::is_octagonal_number(21));
	EXPECT_TRUE(dax::is_octagonal_number(40));
	EXPECT_TRUE(dax::is_octagonal_number(65));
	EXPECT_TRUE(dax::is_octagonal_number(96));
	EXPECT_TRUE(dax::is_octagonal_number(1045));
	EXPECT_TRUE(dax::is_octagonal_number(1160));
	EXPECT_TRUE(dax::is_octagonal_number(1281));
	EXPECT_TRUE(dax::is_octagonal_number(1408));
	EXPECT_TRUE(dax::is_octagonal_number(1541));
	EXPECT_TRUE(dax::is_octagonal_number(1680));
	EXPECT_TRUE(dax::is_octagonal_number(1825));
	EXPECT_TRUE(dax::is_octagonal_number(1976));
	EXPECT_TRUE(dax::is_octagonal_number(2133));
	EXPECT_TRUE(dax::is_octagonal_number(2296));
	EXPECT_TRUE(dax::is_octagonal_number(2465));
	EXPECT_TRUE(dax::is_octagonal_number(2640));
	EXPECT_TRUE(dax::is_octagonal_number(2821));
	EXPECT_TRUE(dax::is_octagonal_number(3008));
	EXPECT_TRUE(dax::is_octagonal_number(3201));
	EXPECT_TRUE(dax::is_octagonal_number(3400));
	EXPECT_TRUE(dax::is_octagonal_number(3605));
	EXPECT_TRUE(dax::is_octagonal_number(3816));
	EXPECT_TRUE(dax::is_octagonal_number(4033));
	EXPECT_TRUE(dax::is_octagonal_number(4256));
	EXPECT_TRUE(dax::is_octagonal_number(4485));
	EXPECT_TRUE(dax::is_octagonal_number(4720));
	EXPECT_TRUE(dax::is_octagonal_number(4961));
	EXPECT_TRUE(dax::is_octagonal_number(5208));
	EXPECT_TRUE(dax::is_octagonal_number(5461));
	EXPECT_TRUE(dax::is_octagonal_number(5720));
	EXPECT_TRUE(dax::is_octagonal_number(5985));
	EXPECT_TRUE(dax::is_octagonal_number(6256));
	EXPECT_TRUE(dax::is_octagonal_number(6533));
	EXPECT_TRUE(dax::is_octagonal_number(6816));
	EXPECT_TRUE(dax::is_octagonal_number(7105));
	EXPECT_TRUE(dax::is_octagonal_number(7400));
	EXPECT_TRUE(dax::is_octagonal_number(7701));
	EXPECT_TRUE(dax::is_octagonal_number(8008));
	EXPECT_TRUE(dax::is_octagonal_number(8321));
	EXPECT_TRUE(dax::is_octagonal_number(8640));
	EXPECT_TRUE(dax::is_octagonal_number(8965));
	EXPECT_TRUE(dax::is_octagonal_number(9296));
	EXPECT_TRUE(dax::is_octagonal_number(9633));
	EXPECT_TRUE(dax::is_octagonal_number(9976));
}

TEST(NUMBER, CUBE)
{
	EXPECT_TRUE(dax::is_cube(8));
	EXPECT_FALSE(dax::is_cube(9));
