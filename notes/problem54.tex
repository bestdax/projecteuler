...
\rowcolors{0}{black!20}{white}
\begin{tabularx}{400pt}{|c|X|X|c|}
	\hline
	Hand & Player 1                    & Player 2 & Winner \\ \hline
	1    & \parbox{4cm}{5H 5C 6S 7S                        \\ KD Pair of Fives}    & \parbox{4cm}{2C 3S 8S 8D TD \\  Pair of Eights}& Player2  \\ \hline
	2    & \parbox{4cm}{5D 8C 9S JS AC                     \\ Highest card Ace}& \parbox{4cm}{2C 5C 7D 8S QH \\ Highest card Queen }& Player 1 \\ \hline
	3	& 	2D 9C AS AH AC Three Aces & & \\ \hline
	4	& 	2D 9C AS AH AC Three Aces & & \\ \hline
	5	& 	2D 9C AS AH AC Three Aces & & \\ \hline
\end{tabularx}
